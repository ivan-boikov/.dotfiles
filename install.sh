...
if [ "$1" = "i" ]; then
    # system
    sudo apt-get -y install xserver-xorg dbus-x11 fonts-liberation gawk fonts-font-awesome xdotool zsh libnotify-bin jmtpfs maim xwallpaper python3-pip xfce4-power-manager redshift i3lock dmenu suckless-tools pass git picom
    # media
